...
###############################################################################
### New 2013 Data
satx_2013 <- read.csv("satx_2013v3.csv", header = TRUE, stringsAsFactors = FALSE)
# Remove null values
...
satx_2014 <- read.csv("satx_2014v3.csv", header = TRUE,
...
# 2015 data load
satx_2015pt1 <- read.csv("satx_2015v3pt1.csv", header = TRUE,
                         stringsAsFactors = FALSE)
View(satx_2015pt1)
satx_2015pt2 <- read.csv("satx_2015v3pt2.csv", header = TRUE,
                         stringsAsFactors = FALSE)
...
# 2016 Data Load
satx_2016pt1 <- read.csv("satx_2016v3pt1.csv", header = TRUE,
                         stringsAsFactors = FALSE)
satx_2016pt2 <- read.csv("satx_2016v3pt2.csv", header = TRUE,
                         stringsAsFactors = FALSE)
satx_2016 <- rbind(satx_2016pt1, satx_2016pt2)
satx_2016 <- pedcycle_cleaning_function(satx_2016)

# 2017 Data Load
satx_2017pt1 <- read.csv("satx_2017v3pt1.csv", header = TRUE,
                         stringsAsFactors = FALSE)
satx_2017pt2 <- read.csv("satx_2017v3pt2.csv", header = TRUE,
                         stringsAsFactors = FALSE)
satx_2017 <- rbind(satx_2017pt1, satx_2017pt2)
satx_2017 <- pedcycle_cleaning_function(satx_2017)

# 2018 Data Load
satx_2018pt1 <- read.csv("satx_2018v3pt1.csv", header = TRUE,
                         stringsAsFactors = FALSE)
satx_2018pt2 <- read.csv("satx_2018v3pt2.csv", header = TRUE,
                         stringsAsFactors = FALSE)
...
# 2019 Data Load
satx_2019pt1 <- read.csv("satx_2019v3pt1.csv", header = TRUE,
                         stringsAsFactors = FALSE)
satx_2019pt2 <- read.csv("satx_2019v3pt2.csv", header = TRUE,
                         stringsAsFactors = FALSE)
...
# 2020 Data Load
satx_2020 <- read.csv("satx_2020v3.csv", header = TRUE,
                      stringsAsFactors = FALSE)
satx_2020 <- pedcycle_cleaning_function(satx_2020)
View(satx_2020)

# 2021 Data Load
satx_2021 <- read.csv("satx_2021v3.csv", header = TRUE,
                      stringsAsFactors = FALSE)
View(satx_2021)
satx_2021 <- pedcycle_cleaning_function(satx_2021)

# 2022 Data Load
satx_2022 <- read.csv("satx_2022v3.csv", header = TRUE,
                      stringsAsFactors = FALSE)
View(satx_2022)
satx_2022 <- pedcycle_cleaning_function(satx_2022)

# 2023 Data Load January - May
satx_2023_jan_may <- read.csv("satx_2023_JanMay.csv", header = TRUE,
                              stringsAsFactors = FALSE)
satx_2023_jan_may <- pedcycle_cleaning_function(satx_2023_jan_may)
View(satx_2023_jan_may)

# 2023 June
satx_2023_june <- read.csv("satx_june_2023.csv", header = TRUE,
                           stringsAsFactors = FALSE)
satx_2023_june <- pedcycle_cleaning_function(satx_2023_june)
View(satx_2023_june)

# 2023 July
satx_2023_july <- read.csv("satx_july_2023.csv", header = TRUE,
                           stringsAsFactors = FALSE)
satx_2023_july <- pedcycle_cleaning_function(satx_2023_july)

# 2023 August
satx_2023_aug <- read.csv("satx_aug_2023.csv", header = TRUE,
                          stringsAsFactors = FALSE)
View(satx_2023_aug)
satx_2023_aug <- pedcycle_cleaning_function(satx_2023_aug)

# 2023 September
satx_2023_sep <- read.csv("satx_sep_2023.csv", header = TRUE,
                          stringsAsFactors = FALSE)
View(satx_2023_sep)
satx_2023_sep <- pedcycle_cleaning_function(satx_2023_sep)

# 2023 October
satx_oct2023 <- read.csv("satx_oct2023.csv", header = TRUE,
                         stringsAsFactors = FALSE)
View(satx_oct2023)
satx_oct2023 <- pedcycle_cleaning_function(satx_oct2023)

# 2023 November
satx_nov2023 <- read.csv("satx_nov_2023.csv", header = TRUE,
                         stringsAsFactors = FALSE)
View(satx_nov2023)
satx_nov2023 <- pedcycle_cleaning_function(satx_nov2023)

# 2023 December
satx_dec2023 <- read.csv("satx_dec_2023.csv", header = TRUE,
                         stringsAsFactors = FALSE)
View(satx_dec2023)
satx_dec2023 <- pedcycle_cleaning_function(satx_dec2023)

# 2024 - January
satx_jan2024 <- read.csv("satx_jan_2024.csv", header = TRUE,
                         stringsAsFactors = FALSE)
View(satx_jan2024)
satx_jan2024 <- pedcycle_cleaning_function(satx_jan2024)

# 2024 - February
satx_feb2024 <- read.csv("satx_feb_2024.csv", header = TRUE,
                         stringsAsFactors = FALSE)
View(satx_feb2024)
satx_feb2024 <- pedcycle_cleaning_function(satx_feb2024)

# 2024 - March
satx_mar2024 <- read.csv("satx_mar_2024.csv", header = TRUE,
                         stringsAsFactors = FALSE)
View(satx_mar2024)
satx_mar2024 <- pedcycle_cleaning_function(satx_mar2024)

# 2024 - April
satx_apr2024 <- read.csv("satx_apr_2024.csv", header = TRUE,
                         stringsAsFactors = FALSE)
View(satx_apr2024)
satx_apr2024 <- pedcycle_cleaning_function(satx_apr2024)

# 2024 - May
satx_may2024 <- read.csv("satx_may_2024.csv", header = TRUE,
                         stringsAsFactors = FALSE)
View(satx_may2024)
satx_may2024 <- pedcycle_cleaning_function(satx_may2024)

# 2024 - June
data <- read.csv("satx_june_2024.csv", header = TRUE,
                          stringsAsFactors = FALSE)
View(data)
satx_june2024 <- pedcycle_cleaning_function(data)

# 2024 - July
data <- read.csv("satx_july_2024.csv", header = TRUE,
                 stringsAsFactors = FALSE)
View(data)
...
# 2024 - August
satx_aug2024 <- read.csv('satx_aug_2024.csv', header = TRUE,
                 stringsAsFactors = FALSE)
View(satx_aug2024)
satx_aug2024 <- pedcycle_cleaning_function(satx_aug2024)

# 2024 - September & October
satx_sepoct2024 <- read.csv('satx_sepoct2024.csv', header=TRUE,
                            stringsAsFactors = FALSE)
...
ped_cycle_df <- rbind(satx_2013, satx_2014, satx_2015, satx_2016, satx_2017, satx_2018,
                      ...
                      satx_aug2024, satx_sepoct2024)
#ped_cycle_df <- rbind(ped_cycle_df, satx_june2024)



## Write final df to csv
write.csv(ped_cycle_df, "ped_cycle_df.csv", row.names = FALSE)
